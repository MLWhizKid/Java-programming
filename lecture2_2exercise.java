...
public class lecture2_2exercise {
    public static void main(String[] args) {
        ...
        try (Scanner input = new Scanner(System.in)) {
            ...
            System.out.printf("The area of radius %.5f%n is %.4f%n" ,radius,area);
            ...
            System.out.println("-----------------------------------\nEXERCISE 2.6");
            double month_deposit = 100.0; // 每月存款金额
            double annual_IR = 0.05; // 年利率
            double monthly_IR = annual_IR / 12.0; // 月利率
            System.out.println("You want to check the value of your account in a few months :");
